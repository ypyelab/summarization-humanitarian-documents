...
if __name__ == "__main__":
    docs_processed_en_dir = 'docs_with_summaries_processed/en/'
    files = [docs_processed_en_dir+'train.src.txt',docs_processed_en_dir+'train.tgt.txt'] #Change according to language
    vocab_file = docs_processed_en_dir + 'vocab.txt'
