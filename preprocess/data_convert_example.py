...
"""
Modified version taken from https://gist.github.com/jorgeramirez/15286b588dc2669ced95bbf6a6803420: 
...
def _binary_to_text_for_neusum():
    reader = codecs.open(FLAGS.in_file, 'rb', encoding = 'utf-8', errors = 'ignore')
    writer_src = codecs.open("%s.src.txt" % FLAGS.out_file, 'w')
    writer_tgt = codecs.open("%s.tgt.txt" % FLAGS.out_file, 'w')
    while True:
